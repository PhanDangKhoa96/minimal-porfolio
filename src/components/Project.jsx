    ...
    return (
        <section className="container">
            ...
            <animated.div ref={reference} style={{ transform: animation.transform, opacity: animation.opacity }} className="flex flex-wrap justify-center items-center gap-10 lg:gap-20 xl:gap-x-[10%] xl:gap-y-24">
                <a href='https://celerity.gtsb.io/' target="_blank" className="w-full max-w-full opacity-50 aspect-square bg-raisin-black shadow-[0_0.1em_1em_0] shadow-black/40 grid place-items-center bg-[url('/celerity.webp')] bg-contain bg-no-repeat bg-center hover:opacity-80 transition-all duration-300 grayscale hover:grayscale-0 md:w-[calc(50%-40px)] lg:w-[calc(50%-80px)] xl:w-[23%] group"></a>
                <a href='https://saigondigital.gatsbyjs.io/' target="_blank" className="w-full max-w-full opacity-50 aspect-square bg-raisin-black shadow-[0_0.1em_1em_0] shadow-black/40 grid place-items-center bg-[url('/SD.png')] bg-contain bg-no-repeat bg-center hover:opacity-80 transition-all duration-300 grayscale hover:grayscale-0 md:w-[calc(50%-40px)] lg:w-[calc(50%-80px)] xl:w-[23%] group"></a>
